...
fun RegistrationScreen(
    onBack: () -> Unit,
    onRegister: (email: String, password: String, remember: Boolean) -> Unit,
                        ...
                        onClick = {
                            ...
                            scope.launch {
                                ...
                                result.onSuccess {
                                    ...
                                    onRegister(email.trim(), password, remember)
                                }.onFailure { error ->
                                    error.printStackTrace()

                                    val message = if (error is retrofit2.HttpException) {
                                        try {
                                            error.response()?.errorBody()?.string() ?: "Ошибка регистрации"
                                        } catch (_: Exception) {
